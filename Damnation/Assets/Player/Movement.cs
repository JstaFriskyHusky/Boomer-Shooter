...
public class Movement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (rb.velocity.y < 0)
        {
            rb.velocity += Vector3.up * Physics.gravity.y * fallMutiplier * Time.deltaTime;
        }
    }
    ...
    {
        if (Physics.Raycast(transform.position, Vector3.down, out slopeHit, playerHeight * 1f + .3f))
        {
